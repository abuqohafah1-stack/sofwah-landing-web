    ...
    <div class="mx-auto max-w-content px-6 py-20 md:py-24">
        ...
        <div class="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5" data-reveal-stagger>
            @foreach ($c['trust_stack']['badges'] as $b)
                <div class="ring-hover flex flex-col items-center gap-3 rounded-xl2 border border-white/10 bg-surface p-5 text-center transition duration-300 hover:-translate-y-1 hover:border-white/25">
        ...
        {{-- Amenities --}}
        <div class="mt-8 flex flex-wrap justify-center gap-2.5" data-reveal-stagger>
